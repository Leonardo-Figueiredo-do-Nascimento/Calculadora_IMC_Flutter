                  ...
                  TextButton(
                    onPressed: (){
                      if(alturaController.text=='' || pesoController.text == ""){
                        ...
                        MedidaSqlite novaMedida = MedidaSqlite(double.parse(pesoController.text), double.parse(alturaController.text), classificacao);
                        medidasRepository.salvarMedida(novaMedida);
                        showModalBottomSheet(
                          context: context, 
                          builder: (BuildContext bc){
                            return Container(
